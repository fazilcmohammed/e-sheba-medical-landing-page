...
const AboutUs = () => {
  return (
    <section className="px-28 py-20 bg-hero_bg flex items-center grid-cols-2 gap-20">
      <div>
        <h1 className="capitalize text-[48px] font-bold text-[#2e2e2e]">
          What <span className="text-blue">our member's</span> <br />
          saying about us
        </h1>
        <p className="text-[#163048] text-[16px] my-6">
          {" "}
        ...
        <div className="flex items-center my-10">
          ...
          <p className=" absolute left-[350px] text-[16px] font-semibold text-[#2E2E2E]">100+ Reviews</p>
        </div>
      </div>
